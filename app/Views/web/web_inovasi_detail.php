            ...
            <div class="col-md-9 mb-4">
                ...
                <section class="border-bottom mb-4">
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-lg text-center text-lg-start mb-3 m-lg-0">
                            ...
                            <span> Uploaded <u><?= $item->updated_at ?></u> by <?= strtoupper($item->alias) ?> | Publish By : <?= ucfirst($item->nama_user) ?></span>
                        </div>
                ...
                <section>
                    ...
                    <embed src="<?= base_url("Web/pdfViewer/$item->id") ?>" width="100%" height="500" alt="pdf">
                </section>
                <!--Section: Text-->
                ...
                <section class="text-center border-top border-bottom py-4 mb-4">
                    ...
                    <div class="fb-share-button d-inline" data-layout="box_count" data-size="small">
                        <a target="_blank" class="btn btn-primary me-1" data-href="http://simudah.bolmutkab.go.id" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="bagikan Di WhatsApp" style="background-color: #3b5998;" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2F<?= $_SERVER['SERVER_NAME'] . str_replace('/', '%2F', $_SERVER['REQUEST_URI']) ?>%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                    </div>

                    <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="bagikan Di Twitter" class="btn btn-primary text-white" style="background-color: #55acee;" data-show-count="false">
                        <i class="fab fa-twitter"></i>
                    </a>

                    <a href="whatsapp://send?text=http://<?= $_SERVER['SERVER_NAME'] . str_replace('/', '%2F', $_SERVER['REQUEST_URI']) ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="bagikan Di WhatsApp" class="btn btn-success text-white">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                </section>
                <!--Section: Share buttons-->
                ...
                <div class="row sticky-top" style="top: 80px;">
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="text-center">
                            <h5 class="mb-4">lastest videos</h5>
