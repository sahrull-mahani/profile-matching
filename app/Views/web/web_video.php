                ...
                <div class="<?= $key > 3 && $key % 4 == 0 ? 'col-lg-12' : 'col-md' ?>">
                    <section class="mt-5">
                        <div class="container img-cover rounded-3" role="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?= ucwords($item->judul) ?>">
                            <img class="videoThumb rounded-3" width="100%" src="http://i1.ytimg.com/vi/<?= $item->link ?>/maxresdefault.jpg" data-bs-toggle="modal" data-bs-target="#example<?= $key ?>">
                        </div>
                    </section>
                </div>

                <!-- Modal -->
                <div class="modal fade" id="example<?= $key ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
