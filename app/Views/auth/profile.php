                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="img-preview profile-user-img img-fluid img-circle" src="<?= $session->foto; ?>" alt="User profile picture">
                            </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class=" active tab-pane" id="timeline">
                                    <?= form_open('auth/change_password', array('class' => 'form-horizontal', 'id' => 'save-account', 'enctype' => 'multipart/form-data')); ?>
                                    ...
                                    <div class="form-group row mode2">
                                        <?= form_label('Foto Profil', 'img', ['class' => 'col-sm-4 col-form-label']); ?>
                                        <div class="col-sm-8 item">
                                            <input type="file" name="img" id="img" class="form-control" required="required" <?= isset($get->img) ? 'readonly' : ''; ?> onchange="privewImg(this)" />
                                        </div>
                                    </div>
                                    <div class="form-group row mode2">
