...
<body class="hold-transition login-page">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 item">
                    <div class="input-group show-pass">
                        <input type="password" class="form-control border-right-0" name="password" placeholder="<?= lang('Auth.login_password_label') ?>" required />
                        <div class="input-group-append">
                            <div class="input-group-text bg-transparent" id="show-password" role="button" tabindex="0">
                                <span class="fas fa-eye" style="font-size: 13px;"></span>
                            </div>
                            <div class="input-group-text">
    ...
    <script>
        $('#show-password').on('click', function(e) {
            ...
            if (icon.attr('class') == 'fas fa-eye-slash') {
                $('input[name=password]').attr('type', 'text')
            }else{
                $('input[name=password]').attr('type', 'password')
            }
        })
        $('#show-password').find('.fas').hide()
        $(".show-pass").hover(function() {
            $('#show-password').find('.fas').show('fast')
        }, function() {
            $('#show-password').find('.fas').hide('slow')
        })
